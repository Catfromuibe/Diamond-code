...
class MeterPool:
    ...
    def plt_meters(self, meter_type: str, step: int, tensorboard_writer: SummaryWriter, value_type='avg'):
        ...
        try:
            ...
            # TensorBoard event file can disappear if ckpt dir is cleaned mid-run.
            pass
