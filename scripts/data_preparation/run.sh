...
python scripts/data_preparation/PEMS/generate_training_data.py
python scripts/data_preparation/M4/generate_training_data.py
...
python scripts/data_preparation/Solar/generate_training_data.py
